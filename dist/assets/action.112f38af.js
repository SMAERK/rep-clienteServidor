...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_VActionDocumentation = resolveComponent("VActionDocumentation");
      const _component_VActionPropsDocumentation = resolveComponent("VActionPropsDocumentation");
      const _component_VActionSlotsDocumentation = resolveComponent("VActionSlotsDocumentation");
