...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_PlaceloadTextBaseDocumentation = resolveComponent("PlaceloadTextBaseDocumentation");
      const _component_PlaceloadTextSizeDocumentation = resolveComponent("PlaceloadTextSizeDocumentation");
      const _component_PlaceloadTextPropsDocumentation = resolveComponent("PlaceloadTextPropsDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_PlaceloadTextBaseDocumentation),
            createVNode(_component_PlaceloadTextSizeDocumentation),
            createVNode(_component_PlaceloadTextPropsDocumentation)
          ], 2),
