...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_BreadcrumbDefaultDocumentation = resolveComponent("BreadcrumbDefaultDocumentation");
      const _component_BreadcrumbArrowDocumentation = resolveComponent("BreadcrumbArrowDocumentation");
      const _component_BreadcrumbBulletDocumentation = resolveComponent("BreadcrumbBulletDocumentation");
      const _component_BreadcrumbDotDocumentation = resolveComponent("BreadcrumbDotDocumentation");
      const _component_BreadcrumbSucceedsDocumentation = resolveComponent("BreadcrumbSucceedsDocumentation");
      const _component_BreadcrumbPropsDocumentation = resolveComponent("BreadcrumbPropsDocumentation");
      const _component_BreadcrumbSlotsDocumentation = resolveComponent("BreadcrumbSlotsDocumentation");
