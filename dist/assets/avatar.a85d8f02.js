...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_PlaceloadAvatarBaseDocumentation = resolveComponent("PlaceloadAvatarBaseDocumentation");
      const _component_PlaceloadAvatarWrapDocumentation = resolveComponent("PlaceloadAvatarWrapDocumentation");
      const _component_PlaceloadAvatarSizeDocumentation = resolveComponent("PlaceloadAvatarSizeDocumentation");
      const _component_PlaceloadAvatarRadiusDocumentation = resolveComponent("PlaceloadAvatarRadiusDocumentation");
      const _component_PlaceloadAvatarPropsDocumentation = resolveComponent("PlaceloadAvatarPropsDocumentation");
