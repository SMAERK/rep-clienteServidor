...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_VFilepondDocumentation = resolveComponent("VFilepondDocumentation");
      const _component_VFilepondPropsDocumentation = resolveComponent("VFilepondPropsDocumentation");
