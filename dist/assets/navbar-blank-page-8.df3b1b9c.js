import __unplugin_components_0 from "./NavbarSearchLayout.650436ee.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    viewWrapper.setPageTitle("Blank Page 8");
    useHead({
      title: "Blank Page 8 - Navbar - Vuero"
    });
    return (_ctx, _cache) => {
      const _component_NavbarSearchLayout = __unplugin_components_0;
      return openBlock(), createBlock(_component_NavbarSearchLayout, { theme: "fade" }, {
        default: withCtx(() => [
          _hoisted_1
        ]),
        _: 1
