import { e as computed, h as unref, ah as getCurrentInstance, k as ref, ai as onBeforeMount, Q as watch, a9 as reactive, ag as isRef, aj as isReactive, ak as isReadonly, al as onBeforeUnmount, aa as inject, a8 as provide, U as nextTick } from "./vendor.6548d360.js";
...
regex(/(^[0-9]*$)|(^-[0-9]+$)/);
regex(/^[-]?\d*(\.\d+)?$/);
export { email as e, minLength as m, required as r, sameAs as s, useVuelidate as u };
