...
import { P as toRefs, k as ref, e as computed, Q as watch, U as nextTick, o as openBlock, p as createBlock, y as createCommentVNode, W as withModifiers, F as Fragment, X as renderList, r as renderSlot, x as createTextVNode, t as toDisplayString, s as createVNode } from "./vendor.6548d360.js";
function g(e) {
...
function O(a, n, r) {
  var i = toRefs(a), o = i.options, s = i.mode, c = i.trackBy, v = i.limit, p = i.hideSelected, d = i.createTag, f = i.createOption, m2 = i.label, O2 = i.appendNewTag, F2 = i.appendNewOption, C2 = i.multipleLabel, A2 = i.object, S2 = i.loading, E2 = i.delay, B2 = i.resolveOnLoad, L2 = i.minChars, P2 = i.filterResults, k = i.clearOnSearch, w = i.clearOnSelect, q = i.valueProp, x = i.canDeselect, T = i.max, j = i.strict, I = i.closeOnSelect, _ = i.groups, V = (i.groupLabel, i.groupOptions), R = i.groupHideEmpty, M = i.groupSelect, $ = r.iv, H = r.ev, N = r.search, G = r.clearSearch, K = r.update, U = r.pointer, W = r.clearPointer, z = r.blur, J = r.focus, Q = r.deactivate, X = ref([]), Y = ref([]), Z = ref(false), ee = computed(function() {
    ...
    return _.value ? Le((Y.value || []).map(function(e) {
      ...
      return D(D({}, e), {}, (y(u = { group: true }, V.value, Pe(t, false).map(function(u2) {
        return Object.assign({}, u2, e.disabled ? { disabled: true } : {});
      })), y(u, "__VISIBLE__", Pe(t).map(function(u2) {
        return Object.assign({}, u2, e.disabled ? { disabled: true } : {});
      })), u));
    })) : [];
    ...
    var e;
    return ee.value !== false && N.value ? Se(N.value) !== -1 ? [] : [(e = {}, y(e, q.value, N.value), y(e, m2.value, N.value), y(e, ce.value, N.value), e)] : [];
  }), ce = computed(function() {
    return c.value || m2.value;
    ...
    switch (h(e) !== "object" && (e = Ae(e)), s.value) {
      case "single":
        K(e);
        break;
      case "multiple":
    ...
    switch (s.value) {
      case "single":
        return !g($.value) && $.value[q.value] == e[q.value];
      case "tags":
      case "multiple":
        return !g($.value) && $.value.map(function(e2) {
          return e2[q.value];
        }).indexOf(e[q.value]) !== -1;
    }
  }, De = function(e) {
    ...
    return N.value && P2.value && (t = t.filter(function(e2) {
      return b(e2[ce.value], j.value).indexOf(b(N.value, j.value)) !== -1;
    ...
    return u = t, Object.prototype.toString.call(u) === "[object Object]" && (t = Object.keys(t).map(function(e2) {
      var u2, l = t[e2];
      return y(u2 = {}, q.value, e2), y(u2, ce.value, l), y(u2, m2.value, l), u2;
    })), t = t.map(function(e2) {
      var u2;
      return h(e2) === "object" ? e2 : (y(u2 = {}, q.value, e2), y(u2, ce.value, e2), y(u2, m2.value, e2), u2);
    });
  }, we = function() {
    ...
    return g(e) ? s.value === "single" ? {} : [] : A2.value ? e : s.value === "single" ? Ae(e) || {} : e.filter(function(e2) {
      return !!Ae(e2);
    }).map(function(e2) {
      return Ae(e2);
    });
  };
  if (s.value !== "single" && !g(H.value) && !Array.isArray(H.value))
  ...
  return o && typeof o.value == "function" ? B2.value ? qe(we) : A2.value == 1 && we() : (Y.value = o.value, we()), E2.value > -1 && watch(N, function(e) {
    e.length < L2.value || (Z.value = true, k.value && (Y.value = []), setTimeout(function() {
    ...
    Y.value = a.options, Object.keys($.value).length || we(), function() {
      if (ne.value)
        if (s.value === "single") {
          var e2 = Ae($.value[q.value])[m2.value];
          $.value[m2.value] = e2, A2.value && (H.value[m2.value] = e2);
        } else
          $.value.forEach(function(e3, u2) {
            var t = Ae($.value[u2][q.value])[m2.value];
            $.value[u2][m2.value] = t, A2.value && (H.value[u2][m2.value] = t);
          });
    }();
      ...
      switch (s.value) {
        ...
        case "tags":
          Fe(e[V.value]) ? fe(e[V.value]) : de(e[V.value].filter(function(e2) {
            ...
            return $.value.length + 1 + u <= T.value || T.value === -1;
          }));
      }
      I.value && Q();
    }
...
function L(u, l, a) {
  var n = toRefs(u), r = n.classes, i = n.disabled, o = n.openDirection, s = n.showOptions, c = a.isOpen, v = a.isPointed, p = a.isSelected, d = a.isDisabled, f = a.isActive, g2 = a.canPointGroups, b2 = a.resolving, h2 = a.fo, m2 = computed(function() {
    return function(e) {
  ...
  return { classList: computed(function() {
    ...
    return { container: [e.container].concat(i.value ? e.containerDisabled : []).concat(D2.value && o.value === "top" ? e.containerOpenTop : []).concat(D2.value && o.value !== "top" ? e.containerOpen : []).concat(f.value ? e.containerActive : []), spacer: e.spacer, singleLabel: e.singleLabel, singleLabelText: e.singleLabelText, multipleLabel: e.multipleLabel, search: e.search, tags: e.tags, tag: [e.tag].concat(i.value ? e.tagDisabled : []), tagRemove: e.tagRemove, tagRemoveIcon: e.tagRemoveIcon, tagsSearchWrapper: e.tagsSearchWrapper, tagsSearch: e.tagsSearch, tagsSearchCopy: e.tagsSearchCopy, placeholder: e.placeholder, caret: [e.caret].concat(c.value ? e.caretOpen : []), clear: e.clear, clearIcon: e.clearIcon, spinner: e.spinner, dropdown: [e.dropdown].concat(o.value === "top" ? e.dropdownTop : []).concat(c.value && s.value && D2.value ? [] : e.dropdownHidden), options: [e.options].concat(o.value === "top" ? e.optionsTop : []), group: e.group, groupLabel: function(u2) {
      var t = [e.groupLabel];
      return v(u2) ? t.push(p(u2) ? e.groupLabelSelectedPointed : e.groupLabelPointed) : p(u2) && g2.value ? t.push(d(u2) ? e.groupLabelSelectedDisabled : e.groupLabelSelected) : d(u2) && t.push(e.groupLabelDisabled), g2.value && t.push(e.groupLabelPointable), t;
...
var P = { name: "Multiselect", emits: ["open", "close", "select", "deselect", "input", "search-change", "tag", "option", "update:modelValue", "change", "clear"], props: { value: { required: false }, modelValue: { required: false }, options: { type: [Array, Object, Function], required: false, default: () => [] }, id: { type: [String, Number], required: false }, name: { type: [String, Number], required: false, default: "multiselect" }, disabled: { type: Boolean, required: false, default: false }, label: { type: String, required: false, default: "label" }, trackBy: { type: String, required: false, default: void 0 }, valueProp: { type: String, required: false, default: "value" }, placeholder: { type: String, required: false, default: null }, mode: { type: String, required: false, default: "single" }, searchable: { type: Boolean, required: false, default: false }, limit: { type: Number, required: false, default: -1 }, hideSelected: { type: Boolean, required: false, default: true }, createTag: { type: Boolean, required: false, default: void 0 }, createOption: { type: Boolean, required: false, default: void 0 }, appendNewTag: { type: Boolean, required: false, default: void 0 }, appendNewOption: { type: Boolean, required: false, default: void 0 }, addTagOn: { type: Array, required: false, default: void 0 }, addOptionOn: { type: Array, required: false, default: void 0 }, caret: { type: Boolean, required: false, default: true }, loading: { type: Boolean, required: false, default: false }, noOptionsText: { type: String, required: false, default: "The list is empty" }, noResultsText: { type: String, required: false, default: "No results found" }, multipleLabel: { type: Function, required: false }, object: { type: Boolean, required: false, default: false }, delay: { type: Number, required: false, default: -1 }, minChars: { type: Number, required: false, default: 0 }, resolveOnLoad: { type: Boolean, required: false, default: true }, filterResults: { type: Boolean, required: false, default: true }, clearOnSearch: { type: Boolean, required: false, default: false }, clearOnSelect: { type: Boolean, required: false, default: true }, canDeselect: { type: Boolean, required: false, default: true }, canClear: { type: Boolean, required: false, default: true }, max: { type: Number, required: false, default: -1 }, showOptions: { type: Boolean, required: false, default: true }, required: { type: Boolean, required: false, default: false }, openDirection: { type: String, required: false, default: "bottom" }, nativeSupport: { type: Boolean, required: false, default: false }, classes: { type: Object, required: false, default: () => ({}) }, strict: { type: Boolean, required: false, default: true }, closeOnSelect: { type: Boolean, required: false, default: true }, autocomplete: { type: String, required: false }, groups: { type: Boolean, required: false, default: false }, groupLabel: { type: String, required: false, default: "label" }, groupOptions: { type: String, required: false, default: "options" }, groupHideEmpty: { type: Boolean, required: false, default: false }, groupSelect: { type: Boolean, required: false, default: true }, inputType: { type: String, required: false, default: "text" } }, setup(n, r) {
  const i = function(l, a) {
    ...
    return { multiselect: d2, tabindex: g2, isActive: f2, blur: b3, focus: h3, handleFocus: function() {
      h3();
    }, activate: function() {
  ...
  }(n, 0, { input: c.input, open: s.open, close: s.close, clearSearch: c.clearSearch }), d = O(n, r, { ev: i.ev, iv: i.iv, search: c.search, clearSearch: c.clearSearch, update: v.update, pointer: o.pointer, clearPointer: o.clearPointer, blur: p.blur, focus: p.focus, deactivate: p.deactivate }), f = function(u, n2, r2) {
    var i2 = toRefs(u), o2 = i2.valueProp, s2 = i2.showOptions, c2 = i2.searchable, v2 = i2.groupLabel, p2 = i2.groups, d2 = i2.mode, f2 = i2.groupSelect, g2 = r2.fo, b3 = r2.fg, h3 = r2.handleOptionClick, m2 = r2.handleGroupClick, D2 = r2.search, y2 = r2.pointer, O2 = r2.setPointer, C2 = r2.clearPointer, A2 = r2.multiselect, S2 = computed(function() {
    ...
    return watch(D2, function(e) {
      ...
      if (y2.value === null)
        ...
        var e = L2.value ? x.value : j.value;
      ...
      if (y2.value === null) {
        ...
        var u2 = L2.value ? I.value : T.value;
        u2 === void 0 && (u2 = L2.value ? k.value : P2.value), O2(u2 || null);
      } else {
  ...
  }(n, 0, { fo: d.fo, fg: d.fg, handleOptionClick: d.handleOptionClick, handleGroupClick: d.handleGroupClick, search: c.search, pointer: o.pointer, setPointer: o.setPointer, clearPointer: o.clearPointer, multiselect: p.multiselect }), b2 = function(u, l, a) {
    var n2 = toRefs(u), r2 = n2.mode, i2 = n2.addTagOn, o2 = n2.openDirection, s2 = n2.searchable, c2 = n2.showOptions, v2 = n2.valueProp, p2 = n2.groups, d2 = n2.addOptionOn, f2 = n2.createTag, g2 = n2.createOption, b3 = a.iv, h3 = a.update, m2 = a.search, D2 = a.setPointer, y2 = a.selectPointer, O2 = a.backwardPointer, F2 = a.forwardPointer, C2 = a.blur, S2 = a.fo, E2 = computed(function() {
      return f2.value || g2.value || false;
    }), B2 = computed(function() {
      return i2.value !== void 0 ? i2.value : d2.value !== void 0 ? d2.value : ["enter"];
    }), L2 = function() {
      r2.value === "tags" && !c2.value && E2.value && s2.value && !p2.value && D2(S2.value[S2.value.map(function(e) {
        return e[v2.value];
      }).indexOf(m2.value)]);
    };
  ...
  }(n, 0, { iv: i.iv, update: v.update, search: c.search, setPointer: o.setPointer, selectPointer: f.selectPointer, backwardPointer: f.backwardPointer, forwardPointer: f.forwardPointer, blur: p.blur, fo: d.fo }), h2 = L(n, 0, { isOpen: s.isOpen, isPointed: f.isPointed, canPointGroups: f.canPointGroups, isSelected: d.isSelected, isDisabled: d.isDisabled, isActive: p.isActive, resolving: d.resolving, fo: d.fo });
...
P.render = function(e, u, t, l, a, g2) {
