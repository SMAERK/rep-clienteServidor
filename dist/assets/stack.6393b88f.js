...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_AvatarStackSmallDocumentation = resolveComponent("AvatarStackSmallDocumentation");
      const _component_AvatarStackRegularDocumentation = resolveComponent("AvatarStackRegularDocumentation");
      const _component_AvatarStackMediumDocumentation = resolveComponent("AvatarStackMediumDocumentation");
      const _component_AvatarStackPropsDocumentation = resolveComponent("AvatarStackPropsDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_AvatarStackSmallDocumentation),
            createVNode(_component_AvatarStackRegularDocumentation),
            createVNode(_component_AvatarStackMediumDocumentation),
            createVNode(_component_AvatarStackPropsDocumentation)
          ], 2),
