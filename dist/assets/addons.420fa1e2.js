...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_AddonEndDocumentation = resolveComponent("AddonEndDocumentation");
      const _component_AddonStartDocumentation = resolveComponent("AddonStartDocumentation");
      const _component_AddonColorsDocumentation = resolveComponent("AddonColorsDocumentation");
      const _component_AddonRoundedDocumentation = resolveComponent("AddonRoundedDocumentation");
      const _component_AddonDirectionalDocumentation = resolveComponent("AddonDirectionalDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_AddonEndDocumentation),
            createVNode(_component_AddonStartDocumentation),
            createVNode(_component_AddonColorsDocumentation),
            createVNode(_component_AddonRoundedDocumentation),
            createVNode(_component_AddonDirectionalDocumentation)
          ], 2),
