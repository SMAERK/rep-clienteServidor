...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_TooltipBaseDocumentation = resolveComponent("TooltipBaseDocumentation");
      const _component_TooltipColorsDocumentation = resolveComponent("TooltipColorsDocumentation");
      const _component_TooltipShapesDocumentation = resolveComponent("TooltipShapesDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_TooltipBaseDocumentation),
            createVNode(_component_TooltipColorsDocumentation),
            createVNode(_component_TooltipShapesDocumentation)
          ], 2),
