...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_RadioOutlinedDocumentation = resolveComponent("RadioOutlinedDocumentation");
      const _component_RadioOutlinedSquareDocumentation = resolveComponent("RadioOutlinedSquareDocumentation");
      const _component_RadioSolidDocumentation = resolveComponent("RadioSolidDocumentation");
      const _component_RadioSolidSquareDocumentation = resolveComponent("RadioSolidSquareDocumentation");
      const _component_RadioPropsDocumentation = resolveComponent("RadioPropsDocumentation");
      const _component_RadioEventsDocumentation = resolveComponent("RadioEventsDocumentation");
