...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_VMessageBaseDocumentation = resolveComponent("VMessageBaseDocumentation");
      const _component_VMessageColorsDocumentation = resolveComponent("VMessageColorsDocumentation");
      const _component_VMessagePropsDocumentation = resolveComponent("VMessagePropsDocumentation");
      const _component_VMessageSlotsDocumentation = resolveComponent("VMessageSlotsDocumentation");
      const _component_VMessageEventsDocumentation = resolveComponent("VMessageEventsDocumentation");
