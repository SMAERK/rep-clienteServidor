...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_FileBaseDocumentation = resolveComponent("FileBaseDocumentation");
      const _component_FileBoxedDocumentation = resolveComponent("FileBoxedDocumentation");
      const _component_FileLeftDocumentation = resolveComponent("FileLeftDocumentation");
      const _component_FileRightDocumentation = resolveComponent("FileRightDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_FileBaseDocumentation),
            createVNode(_component_FileBoxedDocumentation),
            createVNode(_component_FileLeftDocumentation),
            createVNode(_component_FileRightDocumentation)
          ], 2),
