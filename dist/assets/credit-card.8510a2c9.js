...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_VCreditCardDocumentation = resolveComponent("VCreditCardDocumentation");
      const _component_VCreditCardPropsDocumentation = resolveComponent("VCreditCardPropsDocumentation");
