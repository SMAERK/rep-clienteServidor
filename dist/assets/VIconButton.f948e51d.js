...
import { d as defineComponent, e as computed, j as h, z as resolveComponent } from "./vendor.6548d360.js";
const _sfc_main = defineComponent({
  props: {
    ...
    color: {
      ...
      default: void 0,
      validator: (value) => {
        if ([void 0, "primary", "info", "success", "warning", "danger", "white"].indexOf(value) === -1) {
