...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_AnimatedCheckboxDocumentation = resolveComponent("AnimatedCheckboxDocumentation");
      const _component_AnimatedCheckboxPropsDocumentation = resolveComponent("AnimatedCheckboxPropsDocumentation");
      const _component_AnimatedCheckboxEventsDocumentation = resolveComponent("AnimatedCheckboxEventsDocumentation");
