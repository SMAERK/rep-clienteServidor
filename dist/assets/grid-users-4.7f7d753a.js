...
import { _ as __unplugin_components_4 } from "./UserCardDropdown.f26fcac6.js";
...
import { d as defineComponent, k as ref, e as computed, z as resolveComponent, o as openBlock, f as createElementBlock, q as createBaseVNode, s as createVNode, w as withCtx, a3 as withDirectives, a4 as vModelText, g as normalizeClass, h as unref, F as Fragment, X as renderList, t as toDisplayString, p as createBlock, aK as TransitionGroup, x as createTextVNode, a1 as useHead } from "./vendor.6548d360.js";
...
const users = [];
var UsersGridV4_vue_vue_type_style_index_0_lang = "";
...
const _hoisted_5 = { class: "user-grid user-grid-v4" };
...
const _hoisted_10 = { class: "button-wrap has-text-centered" };
const _hoisted_11 = /* @__PURE__ */ createTextVNode(" Add To Project ");
const _hoisted_12 = /* @__PURE__ */ createTextVNode("Add To Team");
const _hoisted_13 = /* @__PURE__ */ createBaseVNode("div", null, [
  /* @__PURE__ */ createBaseVNode("a", { class: "dark-inverted-hover" }, "View Profile")
], -1);
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(filteredData), (item) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("div", _hoisted_8, [
                    ...
                    createBaseVNode("h3", _hoisted_9, toDisplayString(item.fullName), 1),
                    createBaseVNode("p", null, toDisplayString(item.position), 1),
                    createBaseVNode("div", _hoisted_10, [
                      item.added ? (openBlock(), createBlock(_component_VButton, {
                        key: 0,
                        color: "primary",
                        raised: ""
                      }, {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    viewWrapper.setPageTitle("Grid Users 4");
    useHead({
      title: "Grid Users 4 - Sidebar - Vuero"
    });
    return (_ctx, _cache) => {
      const _component_UsersGridV4 = _sfc_main$1;
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(_component_UsersGridV4)
      ]);
    };
  }
});
