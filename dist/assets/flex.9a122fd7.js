...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_VFlexBaseDocumentation = resolveComponent("VFlexBaseDocumentation");
      const _component_VFlexPropsDocumentation = resolveComponent("VFlexPropsDocumentation");
      const _component_VFlexItemPropsDocumentation = resolveComponent("VFlexItemPropsDocumentation");
      const _component_VFlexSlotsDocumentation = resolveComponent("VFlexSlotsDocumentation");
      const _component_VFlexItemSlotsDocumentation = resolveComponent("VFlexItemSlotsDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_VFlexBaseDocumentation),
            createVNode(_component_VFlexPropsDocumentation),
            createVNode(_component_VFlexItemPropsDocumentation),
            createVNode(_component_VFlexSlotsDocumentation),
            createVNode(_component_VFlexItemSlotsDocumentation)
          ], 2),
