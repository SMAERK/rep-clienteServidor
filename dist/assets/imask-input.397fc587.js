...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_VImaskInputDocumentation = resolveComponent("VImaskInputDocumentation");
      const _component_VImaskInputPropsDocumentation = resolveComponent("VImaskInputPropsDocumentation");
