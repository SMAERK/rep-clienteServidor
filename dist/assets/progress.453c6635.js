...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_VProgressBaseDocumentation = resolveComponent("VProgressBaseDocumentation");
      const _component_VProgressColorsDocumentation = resolveComponent("VProgressColorsDocumentation");
      const _component_VProgressUndeterminateDocumentation = resolveComponent("VProgressUndeterminateDocumentation");
      const _component_VProgressPropsDocumentation = resolveComponent("VProgressPropsDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_VProgressBaseDocumentation),
            createVNode(_component_VProgressColorsDocumentation),
            createVNode(_component_VProgressUndeterminateDocumentation),
            createVNode(_component_VProgressPropsDocumentation)
          ], 2),
