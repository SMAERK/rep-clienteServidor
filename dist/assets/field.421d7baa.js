...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_VFieldPropsDocumentation = resolveComponent("VFieldPropsDocumentation");
      const _component_VFieldSlotsDocumentation = resolveComponent("VFieldSlotsDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_VFieldPropsDocumentation),
            createVNode(_component_VFieldSlotsDocumentation)
          ], 2),
