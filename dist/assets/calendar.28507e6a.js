...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_DatepickerBaseDocumentation = resolveComponent("DatepickerBaseDocumentation");
      const _component_DatepickerRangeDocumentation = resolveComponent("DatepickerRangeDocumentation");
      const _component_DatepickerTimeDocumentation = resolveComponent("DatepickerTimeDocumentation");
      const _component_DatepickerTimeSingleDocumentation = resolveComponent("DatepickerTimeSingleDocumentation");
