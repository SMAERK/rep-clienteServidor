...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_GalleryImagesDocumentation = resolveComponent("GalleryImagesDocumentation");
      const _component_GalleryImagesCurvedDocumentation = resolveComponent("GalleryImagesCurvedDocumentation");
      const _component_GalleryImagesRoundedDocumentation = resolveComponent("GalleryImagesRoundedDocumentation");
      const _component_GalleryImagesLargerDocumentation = resolveComponent("GalleryImagesLargerDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_GalleryImagesDocumentation),
            createVNode(_component_GalleryImagesCurvedDocumentation),
            createVNode(_component_GalleryImagesRoundedDocumentation),
            createVNode(_component_GalleryImagesLargerDocumentation)
          ], 2),
