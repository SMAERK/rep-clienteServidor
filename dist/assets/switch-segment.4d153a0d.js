...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_SwitchSegmentDocumentation = resolveComponent("SwitchSegmentDocumentation");
      const _component_SwitchSegmentLabelDocumentation = resolveComponent("SwitchSegmentLabelDocumentation");
      const _component_SwitchSegmentPropsDocumentation = resolveComponent("SwitchSegmentPropsDocumentation");
      const _component_SwitchSegmentEventsDocumentation = resolveComponent("SwitchSegmentEventsDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_SwitchSegmentDocumentation),
            createVNode(_component_SwitchSegmentLabelDocumentation),
            createVNode(_component_SwitchSegmentPropsDocumentation),
            createVNode(_component_SwitchSegmentEventsDocumentation)
          ], 2),
