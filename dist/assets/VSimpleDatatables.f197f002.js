...
import { d as defineComponent, k as ref, a9 as reactive, Y as onMounted, al as onBeforeUnmount, aj as isReactive, Q as watch, o as openBlock, f as createElementBlock, q as createBaseVNode, r as renderSlot } from "./vendor.6548d360.js";
...
class Columns {
  ...
  sort(column, dir, init) {
    ...
    if (th.getAttribute("data-type") === "date") {
      ...
      waitFor.push(import("./date.76e8e052.js").then(({ parseDate }) => (date) => parseDate(date, format)));
    }
...
var style = "";
var VSimpleDatatables_vue_vue_type_style_index_0_lang = "";
