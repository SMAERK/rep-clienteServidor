...
import { d as defineComponent, k as ref, B as watchEffect, U as nextTick, o as openBlock, f as createElementBlock } from "./vendor.6548d360.js";
...
function ordinal() {
  var index = new InternMap(), domain2 = [], range = [], unknown = implicit;
  function scale2(d) {
    let i = index.get(d);
    if (i === void 0) {
      if (unknown !== implicit)
        return unknown;
      index.set(d, i = domain2.push(d) - 1);
    }
...
function loggish(transform2) {
  ...
  scale2.tickFormat = (count, specifier) => {
    ...
    if (count === Infinity)
      return specifier;
    const k = Math.max(1, base * count / scale2.ticks().length);
    return (d) => {
...
function getBrushSelection(ctx) {
  ...
  } else if (main2 && (selection2 = main2.select(".".concat(CLASS.brush)).node())) {
...
function tplProcess(tpl, data2) {
  var res = tpl;
  for (var x2 in data2) {
    res = res.replace(new RegExp("{=".concat(x2, "}"), "g"), data2[x2]);
  }
  return res;
}
...
function checkModuleImport(ctx) {
  ...
  if (isEmpty(config.data_type || config.data_types) && !$$[TYPE_METHOD_NEEDED.LINE]) {
    ...
    for (var x2 in TYPE_METHOD_NEEDED) {
      var t = TYPE[x2];
      if ($$.hasType(t) && !$$[TYPE_METHOD_NEEDED[x2]]) {
        type2 = t;
        break;
      }
    }
...
var data$1 = {
  ...
  generateTargetX: function(rawX, id2, index) {
    var $$ = this;
    var axis2 = $$.axis;
    var x2 = (axis2 === null || axis2 === void 0 ? void 0 : axis2.isCategorized()) ? index : rawX || index;
    if (axis2 === null || axis2 === void 0 ? void 0 : axis2.isTimeSeries()) {
      var fn = parseDate.bind($$);
      x2 = rawX ? fn(rawX) : fn($$.getXValue(id2, index));
    } else if ((axis2 === null || axis2 === void 0 ? void 0 : axis2.isCustomX()) && !(axis2 === null || axis2 === void 0 ? void 0 : axis2.isCategorized())) {
  ...
  getMinMaxValue: function(data2) {
    ...
    (data2 || this.data.targets.map(function(t) {
      ...
      min2 = Math.min.apply(Math, __spreadArray([i ? min2 : Infinity], value, false));
      max2 = Math.max.apply(Math, __spreadArray([i ? max2 : -Infinity], value, false));
    });
  ...
  mapTargetsToUniqueXs: function(targets) {
    ...
    if (targets === null || targets === void 0 ? void 0 : targets.length) {
      ...
      xs = (axis2 === null || axis2 === void 0 ? void 0 : axis2.isTimeSeries()) ? xs.map(function(x2) {
        return new Date(+x2);
      }) : xs.map(Number);
    }
    return sortValue(xs);
  ...
  findClosest: function(values, pos) {
    ...
    data2.filter(function(v) {
      ...
      var shape2 = main2.select(".".concat(CLASS.bars).concat($$.getTargetSelectorSuffix(v.id), " .").concat(CLASS.bar, "-").concat(v.index)).node();
  ...
  getRatio: function(type2, d, asPercent) {
    ...
    if (d && api2.data.shown().length) {
      ...
      if (type2 === "arc") {
        ...
        ratio = max2 === 0 ? 0 : Math.abs(d.value) / max2;
      }
    }
...
var dataLoad = {
  load: function(rawTargets, args) {
    ...
    if (targets) {
      ...
      if (args.type || args.types) {
        targets.forEach(function(t) {
          var _a2;
          var type2 = ((_a2 = args.types) === null || _a2 === void 0 ? void 0 : _a2[t.id]) || args.type;
  ...
  unload: function(rawTargetIds, customDoneCb) {
    ...
    targetIds.forEach(function(id2) {
      ...
      if ($el.legend) {
        $el.legend.selectAll(".".concat(CLASS.legendItem).concat($$.getTargetSelectorSuffix(id2))).remove();
      }
...
var interaction = {
  selectRectForSingle: function(context, eventRect, index) {
    ...
    main2.selectAll(".".concat(CLASS.shape, "-").concat(index)).each(function() {
      var _a2;
      ...
      if (!isTooltipGrouped) {
        (_a2 = $$.hideGridFocus) === null || _a2 === void 0 ? void 0 : _a2.call($$);
        $$.hideTooltip();
  ...
  setOverOut: function(isOver, d) {
    ...
    if (isArc || d !== -1) {
      ...
      if (isArc) {
        callback_1(d, main2.select(".".concat(CLASS.arc).concat($$.getTargetSelectorSuffix(d.id))).node());
      } else if (!config.tooltip_grouped) {
        var last_1 = $$.cache.get(KEY.setOverOut) || [];
        var shape2 = main2.selectAll(".".concat(CLASS.shape, "-").concat(d)).filter(function(d2) {
        ...
        !$$.isMultipleX() && main2.selectAll(".".concat(CLASS.shape, "-").concat(d)).each(function(d2) {
          callback_1(d2, this);
        });
      }
    }
  ...
  dispatchEvent: function(type2, index, mouse) {
    ...
    var isMultipleX = $$.isMultipleX();
    var element = (hasRadar ? radar2.axes.select(".".concat(CLASS.axis, "-").concat(index, " text")) : eventRect || arcs.selectAll(".".concat(CLASS.target, " path")).filter(function(d, i) {
      return i === index;
    })).node();
...
var color = {
  ...
  generateColor: function() {
    ...
    if (isFunction(config.color_tiles)) {
      ...
      var colorizedPatterns = pattern.map(function(p, index) {
        ...
        var id2 = "".concat($$.state.datetimeId, "-pattern-").concat(color2, "-").concat(index);
  ...
  generateDataLabelBackgroundColorFilter: function() {
    ...
    if (backgroundColors) {
      ...
      ids.forEach(function(v) {
        var id2 = "".concat(state.datetimeId, "-labels-bg").concat($$.getTargetSelectorSuffix(v));
  ...
  setOverColor: function(isOver, d) {
    ...
    main2.selectAll(isObject(d) ? ".".concat(CLASS.arc).concat($$.getTargetSelectorSuffix(d.id)) : ".".concat(CLASS.shape, "-").concat(d)).style("fill", color2);
  }
};
var domain = {
    ...
    if (dataGroups.length > 0) {
      ...
      dataGroups.forEach(function(groupIds) {
        ...
        if (idsInGroup.length) {
          ...
          var baseAxisId_1 = axis2.getId(baseId_1);
  ...
  getYDomain: function(targets, axisId, xDomain) {
    ...
    var isZeroBased = __spreadArray([TYPE.BAR, TYPE.BUBBLE, TYPE.SCATTER], TYPE_BY_CATEGORY.Line, true).some(function(v) {
      ...
      return $$.hasType(v, yTargets) && config["".concat(type2, "_zerobased")];
    });
  ...
  getXDomainPadding: function(domain2, tickCount) {
    ...
    var isTimeSeriesTickCount = axis2.isTimeSeries() && tickCount;
    var diff = diffDomain(domain2);
    var defaultValue;
    if (axis2.isCategorized() || isTimeSeriesTickCount) {
      defaultValue = 0;
    } else if ($$.hasType("bar")) {
    ...
    if (padding.unit === "px") {
      ...
      left2 = axis2.getPadding(padding, "left", defaultValue, domainLength);
      right2 = axis2.getPadding(padding, "right", defaultValue, domainLength);
    } else {
      var range = diff + left2 + right2;
  ...
  getXDomain: function(targets) {
    var $$ = this;
    var axis2 = $$.axis, x2 = $$.scale.x;
    var domain2 = [
      $$.getXDomainMinMax(targets, "min"),
      $$.getXDomainMinMax(targets, "max")
    ];
    var _a = domain2[0], min2 = _a === void 0 ? 0 : _a, _b = domain2[1], max2 = _b === void 0 ? 0 : _b;
    if (x2.type !== "log") {
      var isCategorized = axis2.isCategorized();
  ...
  updateXDomain: function(targets, withUpdateXDomain, withUpdateOrgXDomain, withTrim, domain2) {
    var _a;
    var $$ = this;
    var config = $$.config, org = $$.org, _b = $$.scale, x2 = _b.x, subX = _b.subX;
...
var legend$1 = {
  ...
  updateLegend: function(targetIds, options2, transitions) {
    ...
    $el.legend.selectAll(".".concat(CLASS.legendItem)).classed(CLASS.legendItemHidden, function(id2) {
  ...
  updateLegendItemColor: function(id2, color2) {
    ...
    if (legend2) {
      legend2.select(".".concat(CLASS.legendItem, "-").concat(id2, " line")).style("stroke", color2);
    }
  },
  ...
  toggleFocusLegend: function(targetIds, focus) {
    ...
    legend2 && $T(legend2.selectAll(".".concat(CLASS.legendItem)).filter(function(id2) {
      return targetIdz.indexOf(id2) >= 0;
    }).classed(CLASS.legendItemFocused, focus)).style("opacity", function() {
  ...
  revertLegend: function() {
    var $$ = this;
    var legend2 = $$.$el.legend, $T = $$.$T;
    legend2 && $T(legend2.selectAll(".".concat(CLASS.legendItem)).classed(CLASS.legendItemFocused, false)).style("opacity", null);
  },
    ...
    if (config.interaction_enabled) {
      ...
      !isTouch && item.on("mouseout", function(event, id2) {
        ...
        if (!callFn(config.legend_item_onover, api2, id2)) {
          ...
          if (hasGauge) {
            $$.markOverlapped(id2, $$, ".".concat(CLASS.gaugeValue));
          }
  ...
  updateLegendElement: function(targetIds, options2) {
    ...
    var pos = -200;
    var l = legend2.selectAll(".".concat(CLASS.legendItem)).data(targetIdz).enter().append("g");
    $$.setLegendItem(l);
    ...
    background = legend2.select(".".concat(CLASS.legendBackground, " rect"));
    if (state.isLegendInset && maxWidth > 0 && background.size() === 0) {
      background = legend2.insert("g", ".".concat(CLASS.legendItem)).attr("class", CLASS.legendBackground).append("rect");
    }
    ...
    var rects = legend2.selectAll("rect.".concat(CLASS.legendItemEvent)).data(targetIdz);
    ...
    if (usePoint) {
      var tiles = legend2.selectAll(".".concat(CLASS.legendItemPoint)).data(targetIdz);
      ...
      var tiles = legend2.selectAll("line.".concat(CLASS.legendItemTile)).data(targetIdz);
      $T(tiles, withTransition).style("stroke", getColor).attr("x1", x1ForLegendTile).attr("y1", yForLegendTile).attr("x2", x2ForLegendTile).attr("y2", yForLegendTile);
    }
    if (background) {
      $T(background, withTransition).attr("height", $$.getLegendHeight() - 12).attr("width", maxWidth * (step2 + 1) + 10);
    }
...
var redraw = {
  redraw: function(options2) {
    ...
    if (state.hasAxis) {
      ...
      config.data_empty_label_text && main2.select("text.".concat(CLASS.text, ".").concat(CLASS.empty)).attr("x", state.width / 2).attr("y", state.height / 2).text(config.data_empty_label_text).style("display", targetsToShow.length ? "none" : null);
      $$.hasGrid() && $$.updateGrid();
      ...
      $el.text && main2.selectAll(".".concat(CLASS.selectedCircles)).filter($$.isBarType.bind($$)).selectAll("circle").remove();
...
var scale = {
  ...
  updateScales: function(isInit, updateXDomain) {
    ...
    var $$ = this;
    var axis2 = $$.axis, config = $$.config, format2 = $$.format, org = $$.org, scale2 = $$.scale, _c = $$.state, width = _c.width, height = _c.height, width2 = _c.width2, height2 = _c.height2, hasAxis = _c.hasAxis;
    if (hasAxis) {
      var isRotated = config.axis_rotated;
      var min2 = {
        x: isRotated ? 1 : 0,
      ...
      format2.subXAxisTick = axis2.getXAxisTickFormat(true);
...
var shape = {
  ...
  getBarW: function(type2, axis2, targetsNum) {
    ...
    var getWidth = function(id2) {
      ...
      var max2 = id2 ? width.max : config["".concat(configName, "_max")];
...
var text = {
  ...
  initText: function() {
    var $el = this.$el;
    $el.main.select(".".concat(CLASS.chart)).append("g").attr("class", CLASS.chartTexts);
  },
  updateTargetsForText: function(targets) {
    ...
    var mainTextUpdate = $$.$el.main.select(".".concat(CLASS.chartTexts)).selectAll(".".concat(CLASS.chartText)).data(targets).attr("class", function(d) {
  ...
  updateText: function() {
    ...
    var text2 = $el.main.selectAll(".".concat(CLASS.texts)).selectAll(".".concat(CLASS.text)).data($$.labelishData.bind($$));
  ...
  updateTextBacgroundColor: function(d) {
    ...
    if (isString(backgroundColor) || isObject(backgroundColor)) {
      ...
      if (filter2.size()) {
        color2 = "url(#".concat(filter2.attr("id"), ")");
      }
    }
    return color2 || null;
  },
  ...
  meetsLabelThreshold: function(ratio, type2) {
    ...
    var $$ = this;
    var config = $$.config;
    var threshold = config["".concat(type2, "_label_threshold")] || 0;
...
var tooltip$1 = {
  ...
  showTooltip: function(selectedData, eventRect) {
    var _a, _b;
    var $$ = this;
    var config = $$.config, scale2 = $$.scale, state = $$.state, tooltip2 = $$.$el.tooltip;
    ...
    var _c = datum2 || {}, _d = _c.width, width = _d === void 0 ? 0 : _d, _e = _c.height, height = _e === void 0 ? 0 : _e;
    ...
    if (!bindto) {
      ...
      var _f = getPointer(state.event, eventRect), x2 = _f[0], y3 = _f[1];
      var currPos = { x: x2, y: y3 };
      var data2 = (_b = selectedData.filter(Boolean)) === null || _b === void 0 ? void 0 : _b.shift();
      if (scale2.x && data2 && "x" in data2) {
        currPos.xAxis = scale2.x(data2.x);
      }
    ...
    if ((event === null || event === void 0 ? void 0 : event.isTrusted) && config.tooltip_linked && charts.length > 1) {
      ...
      charts.filter(function(c) {
        ...
        if (isLinked && linkedName_1 === name && isInDom) {
          ...
          var isNotSameIndex = index !== (data2 === null || data2 === void 0 ? void 0 : data2.index);
          try {
...
var transform = {
  getTranslate: function(target, index) {
    ...
    return "translate(".concat(x2, ", ").concat(y3, ")");
  },
  transformMain: function(withTransition, transitions) {
    var $$ = this;
    var main2 = $$.$el.main, $T = $$.$T;
    var xAxis = (transitions === null || transitions === void 0 ? void 0 : transitions.axisX) ? transitions.axisX : $T(main2.select(".".concat(CLASS.axisX)), withTransition);
    var yAxis = (transitions === null || transitions === void 0 ? void 0 : transitions.axisY) ? transitions.axisY : $T(main2.select(".".concat(CLASS.axisY)), withTransition);
    var y2Axis = (transitions === null || transitions === void 0 ? void 0 : transitions.axisY2) ? transitions.axisY2 : $T(main2.select(".".concat(CLASS.axisY2)), withTransition);
    $T(main2, withTransition).attr("transform", $$.getTranslate("main"));
    xAxis.attr("transform", $$.getTranslate("x"));
    yAxis.attr("transform", $$.getTranslate("y"));
    y2Axis.attr("transform", $$.getTranslate("y2"));
    main2.select(".".concat(CLASS.chartArcs)).attr("transform", $$.getTranslate("arc"));
  },
...
var ChartInternal = function() {
  ...
  ChartInternal2.prototype.initWithData = function(data2) {
    ...
    if (config.data_empty_label_text) {
      main2.append("text").attr("class", "".concat(CLASS.text, " ").concat(CLASS.empty)).attr("text-anchor", "middle").attr("dominant-baseline", "middle");
    }
    if (hasAxis) {
  ...
  ChartInternal2.prototype.showTargets = function() {
    var $$ = this;
    var svg = $$.$el.svg, $T = $$.$T;
    $T(svg.selectAll(".".concat(CLASS.target)).filter(function(d) {
...
var apiFocus = {
  focus: function(targetIdsValue) {
    ...
    if ($$.hasArcType() && !state.hasRadar) {
      $$.expandArc(targetIds);
      $$.hasType("gauge") && $$.markOverlapped(targetIdsValue, $$, ".".concat(CLASS.gaugeValue));
    }
  ...
  defocus: function(targetIdsValue) {
    ...
    if ($$.hasArcType()) {
      ...
      $$.hasType("gauge") && $$.undoMarkOverlapped($$, ".".concat(CLASS.gaugeValue));
    }
...
function setMinMax($$, type2, value) {
  var config = $$.config;
  var axisX = "axis_x_".concat(type2);
  var axisY = "axis_y_".concat(type2);
  var axisY2 = "axis_y2_".concat(type2);
  if (isDefined(value)) {
...
extend(regions, {
  ...
  remove: function(optionsValue) {
    ...
    var regions2 = $$.$el.main.select(".".concat(CLASS.regions)).selectAll(classes2.map(function(c) {
      return ".".concat(c);
    }));
...
var Axis = function() {
  ...
  Axis2.prototype.getAxisClassName = function(id2) {
    return "".concat(CLASS.axis, " ").concat(CLASS["axis".concat(capitalize(id2))]);
  };
  ...
  Axis2.prototype.getMaxTickWidth = function(id2, withoutRecompute) {
    ...
    var maxWidth = 0;
    if (withoutRecompute || !config["axis_".concat(id2, "_show")] || $$.filterTargetsToShow().length === 0) {
  ...
  Axis2.prototype.updateLabels = function(withTransition) {
    ...
    var main2 = $$.$el.main, $T = $$.$T;
    var labels = {
      x: main2.select(".".concat(CLASS.axisX, " .").concat(CLASS.axisXLabel)),
      y: main2.select(".".concat(CLASS.axisY, " .").concat(CLASS.axisYLabel)),
      y2: main2.select(".".concat(CLASS.axisY2, " .").concat(CLASS.axisY2Label))
    };
  ...
  Axis2.prototype.generateTransitions = function(withTransition) {
    var $$ = this.owner;
    var axis2 = $$.$el.axis, $T = $$.$T;
    var _a = ["x", "y", "y2", "subX"].map(function(v) {
      return $T(axis2[v], withTransition);
  ...
  Axis2.prototype.redraw = function(transitions, isHidden, isInit) {
    ...
    ["x", "y", "y2", "subX"].forEach(function(id2) {
      ...
      if (axis2 && $axis) {
        ...
        axis2.create(transitions["axis".concat(capitalize(id2))]);
      }
    });
    this.updateAxes();
  };
    ...
    ["subX", "x", "y", "y2"].forEach(function(type2) {
      ...
      if (axis2 && toCull) {
        ...
        if (type2 === "x") {
          ...
          $el.svg.selectAll(".".concat(CLASS.axisX, " .tick text")).attr("clip-path", clipPath);
        }
      }
    });
  };
...
var eventrect = {
  initEventRect: function() {
    var $$ = this;
    $$.$el.main.select(".".concat(CLASS.chart)).append("g").attr("class", CLASS.eventRects).style("fill-opacity", "0");
  },
  redrawEventRect: function() {
    ...
    if ($el.eventRect) {
      ...
      var eventRects = $$.$el.main.select(".".concat(CLASS.eventRects)).style("cursor", config.zoom_enabled && config.zoom_type !== "drag" ? config.axis_rotated ? "ns-resize" : "ew-resize" : null).classed(CLASS.eventRectsMultiple, isMultipleX).classed(CLASS.eventRectsSingle, !isMultipleX);
      var eventRectUpdate = eventRects.selectAll(".".concat(CLASS.eventRect)).data([0]).enter().append("rect");
    ...
    if ($$.isMultipleX()) {
      ...
      if ($$.axis.isCategorized()) {
        ...
        rectW_1 = function(d) {
          ...
          Object.keys(x3).forEach(function(key, i) {
            var _a;
            x3[key] = (_a = x3[key]) !== null && _a !== void 0 ? _a : xDomain[i];
          });
  ...
  clickHandlerForSingleX: function(d, ctx) {
    ...
    var index = d.index;
    main2.selectAll(".".concat(CLASS.shape, "-").concat(index)).each(function(d2) {
      var _a;
  ...
  clickHandlerForMultipleXS: function(ctx) {
    ...
    if ($$.isBarType(closest.id) || $$.dist(closest, mouse) < config.point_sensitivity) {
      $$.$el.main.selectAll(".".concat(CLASS.shapes).concat($$.getTargetSelectorSuffix(closest.id))).selectAll(".".concat(CLASS.shape, "-").concat(closest.index)).each(function() {
        var _a;
...
var clip = {
  initClip: function() {
    ...
    clip2.id = "".concat($$.state.datetimeId, "-clip");
...
var grid = {
  ...
  initGridLines: function() {
    ...
    if (config.grid_x_lines.length || config.grid_y_lines.length) {
      $el.gridLines.main = $el.main.insert("g", ".".concat(CLASS.chart).concat(config.grid_lines_front ? " + *" : "")).attr("clip-path", clip2.pathGrid).attr("class", "".concat(CLASS.grid, " ").concat(CLASS.gridLines));
  ...
  updateXGrid: function(withoutUpdate) {
    ...
    grid2.x = main2.select(".".concat(CLASS.xgrids)).selectAll(".".concat(CLASS.xgrid)).data(xgridData);
    grid2.x.exit().remove();
  ...
  updateYGrid: function() {
    ...
    grid2.y = main2.select(".".concat(CLASS.ygrids)).selectAll(".".concat(CLASS.ygrid)).data(gridValues);
    grid2.y.exit().remove();
  ...
  updateXGridLines: function() {
    ...
    var xLines = main2.select(".".concat(CLASS.xgridLines)).selectAll(".".concat(CLASS.xgridLine)).data(config.grid_x_lines);
    ...
    $T(xLines.attr("class", function(d) {
      return "".concat(CLASS.xgridLine, " ").concat(d["class"] || "").trim();
  ...
  updateYGridLines: function() {
    ...
    var ygridLines = $el.main.select(".".concat(CLASS.ygridLines)).selectAll(".".concat(CLASS.ygridLine)).data(config.grid_y_lines);
    ...
    $T(ygridLines.attr("class", function(d) {
      return "".concat(CLASS.ygridLine, " ").concat(d["class"] || "").trim();
  ...
  hideGridFocus: function() {
    ...
    if (inputType === "mouse" || !resizing) {
      main2.selectAll("line.".concat(CLASS.xgridFocus, ", line.").concat(CLASS.ygridFocus)).style("visibility", "hidden");
  ...
  updateGridFocus: function() {
    ...
    var xgridFocus = grid2.main.select("line.".concat(CLASS.xgridFocus));
    if (inputType === "touch") {
      if (xgridFocus.empty()) {
  ...
  generateGridData: function(type2, scale2) {
    var $$ = this;
    var tickNum = $$.$el.main.select(".".concat(CLASS.axisX)).selectAll(".tick").size();
    var gridData = [];
    if (type2 === "year") {
...
var region = {
  ...
  updateRegion: function() {
    ...
    var list = region2.main.selectAll(".".concat(CLASS.region)).data(config.regions);
...
var sizeAxis = {
  ...
  getAxisWidthByAxisId: function(id2, withoutRecompute) {
    ...
    var $$ = this;
    if ($$.axis) {
      var position = (_a = $$.axis) === null || _a === void 0 ? void 0 : _a.getLabelPositionById(id2);
...
var shapeArc = {
  initPie: function() {
    ...
    var padAngle = ($$.hasType("pie") && padding ? padding * 0.01 : config["".concat(dataType, "_padAngle")]) || 0;
  ...
  transformForArcLabel: function(d) {
    ...
    if (updated) {
      if ($$.hasMultiArcGauge()) {
        ...
        translate = "translate(".concat(x2, ",").concat(y3, ")");
      } else if (!$$.hasType("gauge") || $$.data.targets.length > 1) {
        var outerRadius = $$.getRadius(d).outerRadius;
        var c = this.svgArc.centroid(updated);
        var _a = c.map(function(v) {
          return isNaN(v) ? 0 : v;
        }), x2 = _a[0], y3 = _a[1];
        ...
        translate = "translate(".concat(x2 * ratio, ",").concat(y3 * ratio, ")");
      }
    }
    return translate;
  },
    ...
    if (transiting) {
      var interval_1 = setInterval(function() {
        if (!transiting) {
          ...
          $el.legend.selectAll(".".concat(CLASS.legendItemFocused)).size() > 0 && $$.expandArc(targetIds);
        }
      }, 10);
      return;
    }
    var newTargetIds = $$.mapToTargetIds(targetIds);
    $el.svg.selectAll($$.selectorTargets(newTargetIds, ".".concat(CLASS.chartArc))).each(function(d) {
  ...
  unexpandArc: function(targetIds) {
    ...
    var newTargetIds = $$.mapToTargetIds(targetIds);
    svg.selectAll($$.selectorTargets(newTargetIds, ".".concat(CLASS.chartArc))).selectAll("path").transition().duration(function(d) {
      return $$.getExpandConfig(d.data.id, "duration");
    }).attr("d", $$.svgArc);
    svg.selectAll("".concat(CLASS.arc)).style("opacity", null);
  },
  ...
  updateTargetsForArc: function(targets) {
    ...
    var mainPieUpdate = chartArcs.selectAll(".".concat(CLASS.chartArc)).data($$.pie(targets)).attr("class", function(d) {
  ...
  initArc: function() {
    var $$ = this;
    var $el = $$.$el;
    $el.arcs = $el.main.select(".".concat(CLASS.chart)).append("g").attr("class", CLASS.chartArcs).attr("transform", $$.getTranslate("arc"));
    $$.setArcTitle();
  },
  ...
  redrawArc: function(duration, durationForExit, withTransform) {
    ...
    var mainArc = main2.selectAll(".".concat(CLASS.arcs)).selectAll(".".concat(CLASS.arc)).data($$.arcData.bind($$));
  ...
  redrawBackgroundArcs: function() {
    ...
    if (hasMultiArcGauge) {
      var index_1 = 0;
      backgroundArc = backgroundArc.selectAll("path.".concat(CLASS.chartArcsBackground)).data($$.data.targets);
      backgroundArc.enter().append("path").attr("class", function(d, i) {
        return "".concat(CLASS.chartArcsBackground, " ").concat(CLASS.chartArcsBackground, "-").concat(i);
  ...
  redrawArcText: function(duration) {
    ...
    if (!(hasGauge && $$.data.targets.length === 1 && config.gauge_title)) {
      text2 = main2.selectAll(".".concat(CLASS.chartArc)).select("text").style("opacity", "0").attr("class", function(d) {
    ...
    main2.select(".".concat(CLASS.chartArcsTitle)).style("opacity", $$.hasType("donut") || hasGauge ? null : "0");
    if (hasGauge) {
      var isFullCircle = config.gauge_fullCircle;
      isFullCircle && (text2 === null || text2 === void 0 ? void 0 : text2.attr("dy", "".concat(hasMultiArcGauge ? 0 : Math.round(state.radius / 14))));
      if (config.gauge_label_show) {
        arcs.select(".".concat(CLASS.chartArcsGaugeUnit)).attr("dy", "".concat(isFullCircle ? 1.5 : 0.75, "em")).text(config.gauge_units);
        arcs.select(".".concat(CLASS.chartArcsGaugeMin)).attr("dx", "".concat(-1 * (state.innerRadius + (state.radius - state.innerRadius) / (isFullCircle ? 1 : 2)), "px")).attr("dy", "1.2em").text($$.textForGaugeMinMax(config.gauge_min, false));
        !isFullCircle && arcs.select(".".concat(CLASS.chartArcsGaugeMax)).attr("dx", "".concat(state.innerRadius + (state.radius - state.innerRadius) / 2, "px")).attr("dy", "1.2em").text($$.textForGaugeMinMax(config.gauge_max, true));
      }
    }
  }
};
var shapeArea = {
  initArea: function(mainLine) {
    var $$ = this;
    var config = $$.config;
    mainLine.insert("g", ".".concat(CLASS[config.area_front ? "circles" : "lines"])).attr("class", $$.getClass("areas", true));
  },
  updateAreaGradient: function() {
    var $$ = this;
    var config = $$.config, datetimeId = $$.state.datetimeId, defs = $$.$el.defs;
    $$.data.targets.forEach(function(d) {
      var id2 = "".concat(datetimeId, "-areaGradient").concat($$.getTargetSelectorSuffix(d.id));
      if ($$.isAreaType(d) && defs.select("#".concat(id2)).empty()) {
        var color_1 = $$.color(d);
        ...
        var linearGradient_1 = defs.append("linearGradient").attr("id", "".concat(id2)).attr("x1", x2[0]).attr("x2", x2[1]).attr("y1", y3[0]).attr("y2", y3[1]);
  ...
  updateAreaColor: function(d) {
    var $$ = this;
    return $$.config.area_linearGradient ? "url(#".concat($$.state.datetimeId, "-areaGradient").concat($$.getTargetSelectorSuffix(d.id), ")") : $$.color(d);
  },
  updateArea: function(withTransition, isSub) {
    ...
    var area2 = $root.main.selectAll(".".concat(CLASS.areas)).selectAll(".".concat(CLASS.area)).data($$.lineData.bind($$));
...
var shapeBar = {
  initBar: function() {
    ...
    $el.bar = $el.main.select(".".concat(CLASS.chart)).insert("g", ":first-child").attr("class", CLASS.chartBars);
  ...
  updateTargetsForBar: function(targets) {
    ...
    var mainBarUpdate = $$.$el.main.select(".".concat(CLASS.chartBars)).selectAll(".".concat(CLASS.chartBar)).data(targets.filter(function(v) {
  ...
  updateBar: function(withTransition, isSub) {
    ...
    var bar2 = $root.main.selectAll(".".concat(CLASS.bars)).selectAll(".".concat(CLASS.bar)).data($$.labelishData.bind($$));
  ...
  generateDrawBar: function(barIndices, isSub) {
    ...
    return function(d, i) {
      ...
      if (d.value !== 0 && getRadius && !isGrouped) {
        ...
        var arc2 = "a".concat(radius, ",").concat(radius, " ").concat(isNegative ? "1 0 0" : "0 0 1", " ");
        pathRadius[+!isRotated] = "".concat(arc2).concat(radius, ",").concat(radius);
        pathRadius[+isRotated] = "".concat(arc2).concat([-radius, radius][isRotated ? "sort" : "reverse"]());
        isNegative && pathRadius.reverse();
      }
      var path2 = isRotated ? "H".concat(points[1][indexX] - radius, " ").concat(pathRadius[0], "V").concat(points[2][indexY] - radius, " ").concat(pathRadius[1], "H").concat(points[3][indexX]) : "V".concat(points[1][indexY] + (isNegative ? -radius : radius), " ").concat(pathRadius[0], "H").concat(points[2][indexX] - radius, " ").concat(pathRadius[1], "V").concat(points[3][indexY]);
...
var shapeGauge = {
  ...
  redrawMultiArcGauge: function() {
    ...
    var arcLabelLines = $el.main.selectAll(".".concat(CLASS.arcs)).selectAll(".".concat(CLASS.arcLabelLine)).data($$.arcData.bind($$));
    var mainArcLabelLine = arcLabelLines.enter().append("rect").attr("class", function(d) {
      return "".concat(CLASS.arcLabelLine, " ").concat(CLASS.target, " ").concat(CLASS.target, "-").concat(d.data.id);
    }).merge(arcLabelLines);
    mainArcLabelLine.style("fill", function(d) {
      ...
      if (hiddenTargetIds.indexOf(d.data.id) < 0) {
        ...
        transform2 = "rotate(".concat(lineAngle * 180 / Math.PI, ", ").concat(x2, ", ").concat(y3, ")");
      }
      select(this).attr("x", x2).attr("y", y3).attr("width", lineLength).attr("height", lineThickness).attr("transform", transform2).style("stroke-dasharray", "0, ".concat(lineLength + lineThickness, ", 0"));
    });
  },
...
var shapeLine = {
  initLine: function() {
    var $el = this.$el;
    $el.line = $el.main.select(".".concat(CLASS.chart)).append("g").attr("class", CLASS.chartLines);
  },
  updateTargetsForLine: function(t) {
    ...
    var mainLineUpdate = main2.select(".".concat(CLASS.chartLines)).selectAll(".".concat(CLASS.chartLine)).data(targets).attr("class", function(d) {
  ...
  updateLine: function(withTransition, isSub) {
    ...
    var $root = isSub ? $el.subchart : $el;
    var line2 = $root.main.selectAll(".".concat(CLASS.lines)).selectAll(".".concat(CLASS.line)).data($$.lineData.bind($$));
...
var shapePoint = {
  ...
  initCircle: function() {
    ...
    var main2 = $$.$el.main;
    $$.point = $$.generatePoint();
    if (($$.hasType("bubble") || $$.hasType("scatter")) && main2.select(".".concat(CLASS.chartCircles)).empty()) {
      main2.select(".".concat(CLASS.chart)).append("g").attr("class", CLASS.chartCircles);
    }
  },
  updateTargetForCircle: function(targetsValue, enterNodeValue) {
    ...
    if (!targets) {
      ...
      var mainCircle = $el.main.select(".".concat(CLASS.chartCircles)).style("pointer-events", "none").selectAll(".".concat(CLASS.circles)).data(targets).attr("class", classCircles);
    ...
    selectionEnabled && targets.forEach(function(t) {
      $el.main.selectAll(".".concat(CLASS.selectedCircles).concat($$.getTargetSelectorSuffix(t.id))).selectAll("".concat(CLASS.selectedCircle)).each(function(d) {
  ...
  updateCircle: function(isSub) {
    ...
    if (config.point_show && !state.toggling) {
      var circles = $root.main.selectAll(".".concat(CLASS.circles)).selectAll(".".concat(CLASS.circle)).data(function(d) {
      ...
      $root.circle = $root.main.selectAll(".".concat(CLASS.circles, " .").concat(CLASS.circle)).style("stroke", $$.color).style("opacity", $$.initialOpacityForCircle.bind($$));
    }
  },
  ...
  expandCircles: function(i, id2, reset) {
    ...
    var circles = $$.getShapeByIndex("circle", i, id2).classed(CLASS.EXPANDED, true);
    ...
    if ($$.isCirclePoint()) {
      ...
      circles.each(function() {
        ...
        if (this.tagName === "circle") {
          ...
          point2.attr("transform", "translate(".concat(x2, " ").concat(y3, ") scale(").concat(scale2, ")"));
        }
      });
    }
  },
  unexpandCircles: function(i) {
    ...
    circles.attr("r", r);
    !$$.isCirclePoint() && circles.attr("transform", "scale(".concat(r(circles) / $$.config.point_r, ")"));
  },
  pointR: function(d) {
    var $$ = this;
    var config = $$.config;
  ...
  generatePoint: function() {
    ...
    return function(method, context) {
      ...
      return function(d) {
        ...
        return point2[method].bind(context).apply(void 0, __spreadArray([element], args, false));
      };
    };
  },
  custom: {
...
var shapeRadar = {
  initRadar: function() {
    ...
    if ($$.hasType("radar")) {
      $el.radar = $el.main.select(".".concat(CLASS.chart)).append("g").attr("class", CLASS.chartRadars);
  ...
  redrawRadar: function() {
    ...
    if (translate) {
      ...
      main2.select(".".concat(CLASS.chartTexts)).attr("transform", translate);
      $$.generateRadarPoints();
      $$.updateRadarLevel();
      $$.updateRadarAxes();
      $$.updateRadarShape();
  ...
  updateRadarLevel: function() {
    ...
    var level = radarLevels.selectAll(".".concat(CLASS.level)).data(levelData);
    level.exit().remove();
    var levelEnter = level.enter().append("g").attr("class", function(d, i) {
      return "".concat(CLASS.level, " ").concat(CLASS.level, "-").concat(i);
    });
  ...
  updateRadarAxes: function() {
    ...
    var axisEnter = axis2.enter().append("g").attr("class", function(d, i) {
      return "".concat(CLASS.axis, "-").concat(i);
    });
...
function withinRange(domain2, current, range) {
  ...
  return domain2.every(function(v, i) {
    return (i === 0 ? v >= min2 : v <= max2) && !domain2.every(function(v2, i2) {
...
var zoom$1 = function(domainValue) {
  var _a;
  var $$ = this.internal;
  var $el = $$.$el, axis2 = $$.axis, config = $$.config, org = $$.org, scale2 = $$.scale;
  var isRotated = config.axis_rotated;
  var isCategorized = axis2.isCategorized();
  var domain2 = domainValue;
  if (config.zoom_enabled && domain2) {
    ...
    if (withinRange(domain2, $$.getZoomDomain(true), $$.getZoomDomain())) {
      ...
      if (config.subchart_show) {
        ...
        $$.brush.getSelection().call($$.brush.move, domain2.map(x2));
      } else {
        ...
        $el.eventRect.call($$.zoom.transform, transform2);
      }
      $$.setZoomResetButton();
    }
  } else {
...
var drag = {
  drag: function(mouse) {
    ...
    main2.select(".".concat(CLASS.dragarea)).attr("x", minX).attr("y", minY).attr("width", maxX - minX).attr("height", maxY - minY);
    main2.selectAll(".".concat(CLASS.shapes)).selectAll(".".concat(CLASS.shape)).filter(function(d) {
  ...
  dragstart: function(mouse) {
    ...
    main2.select(".".concat(CLASS.chart)).append("rect").attr("class", CLASS.dragarea).style("opacity", "0.1");
    $$.setDragStatus(true);
  },
  dragend: function() {
    var $$ = this;
    ...
    $T(main2.select(".".concat(CLASS.dragarea))).style("opacity", "0").remove();
    main2.selectAll(".".concat(CLASS.shape)).classed(CLASS.INCLUDED, false);
    $$.setDragStatus(false);
  }
};
_assign(_assign({}, drag), {
  selectPoint: function(target, d, i) {
    ...
    $T(main2.select(".".concat(CLASS.selectedCircles).concat($$.getTargetSelectorSuffix(d.id))).selectAll(".".concat(CLASS.selectedCircle, "-").concat(i)).data([d]).enter().append("circle").attr("class", function() {
  ...
  unselectPoint: function(target, d, i) {
    ...
    $T(main2.select(".".concat(CLASS.selectedCircles).concat($$.getTargetSelectorSuffix(d.id))).selectAll(".".concat(CLASS.selectedCircle, "-").concat(i))).attr("r", 0).remove();
  },
  ...
  toggleShape: function(that, d, i) {
    ...
    if (config.data_selection_enabled && config.data_selection_isselectable.bind($$.api)(d)) {
      if (!config.data_selection_multiple) {
        var selector2 = ".".concat(CLASS.shapes);
        if (config.data_selection_grouped) {
          selector2 += $$.getTargetSelectorSuffix(d.id);
        }
        main2.selectAll(selector2).selectAll(".".concat(CLASS.shape)).each(function(d2, i2) {
...
export { _sfc_main as _, area as a, areaLineRange as b, areaSplineRange as c, bar as d, step as e, areaStep as f, bubble as g, scatter as h, donut as i, gauge as j, line as l, pie as p, radar as r, spline as s };
