...
import { d as defineComponent, o as openBlock, f as createElementBlock, r as renderSlot, g as normalizeClass, a0 as useRoute, e as computed, j as h, R as RouterLink, k as ref, az as useDebounce, Q as watch, B as watchEffect, a9 as reactive, a8 as provide, aa as inject, aj as isReactive, aA as toRaw, F as Fragment, X as renderList, p as createBlock, A as resolveDynamicComponent, t as toDisplayString, h as unref, y as createCommentVNode, q as createBaseVNode, w as withCtx, a2 as withKeys, W as withModifiers } from "./vendor.6548d360.js";
...
const _hoisted_4 = { class: "language-json py-4" };
        ...
        renderSlot(_ctx.$slots, "body", {}, () => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(data), (row, index) => {
            return openBlock(), createElementBlock(Fragment, { key: index }, [
              ...
              createBaseVNode("div", {
                class: normalizeClass(["flex-table-item has-slimscroll-x", [props.clickable && "is-clickable"]]),
                      ...
                      default: withCtx(() => [
                        renderSlot(_ctx.$slots, "body-cell", {
                          ...
                          column.renderRow ? (openBlock(), createBlock(resolveDynamicComponent({ render: () => {
                            ...
                            __props.printObjects ? (openBlock(), createElementBlock("details", _hoisted_3, [
...
export { _sfc_main as _, _sfc_main$2 as a, _sfc_main$1 as b, _sfc_main$3 as c };
