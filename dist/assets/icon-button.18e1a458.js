...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_VIconButtonDefaultDocumentation = resolveComponent("VIconButtonDefaultDocumentation");
      const _component_VIconButtonPropsDocumentation = resolveComponent("VIconButtonPropsDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_VIconButtonDefaultDocumentation),
            createVNode(_component_VIconButtonPropsDocumentation)
          ], 2),
