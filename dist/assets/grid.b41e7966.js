...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_VGridBaseDocumentation = resolveComponent("VGridBaseDocumentation");
      const _component_VGridPropsDocumentation = resolveComponent("VGridPropsDocumentation");
      const _component_VGridItemPropsDocumentation = resolveComponent("VGridItemPropsDocumentation");
      const _component_VGridSlotsDocumentation = resolveComponent("VGridSlotsDocumentation");
      const _component_VGridItemSlotsDocumentation = resolveComponent("VGridItemSlotsDocumentation");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", {
            ...
            createVNode(_component_VGridBaseDocumentation),
            createVNode(_component_VGridPropsDocumentation),
            createVNode(_component_VGridItemPropsDocumentation),
            createVNode(_component_VGridSlotsDocumentation),
            createVNode(_component_VGridItemSlotsDocumentation)
          ], 2),
