			...
			<div class="wrapper-inner">
				...
				<div class="inbox-sidebar" :class="[mobileSidebarOpen && 'mobile-active']">
					...
					<div class="header-area">
						...
						<div ref="dropdownElement1" class="dropdown inbox-dropdown dropdown-trigger is-right">
							<div>
							...
							<div class="dropdown-menu">
								<div class="dropdown-content">
									<a class="dropdown-item">
										<i aria-hidden="true" class="iconify" data-icon="feather:refresh-cw"></i>
										<span>Refresh</span>
									</a>
									<a class="dropdown-item">
					...
					<div class="sidebar-inner">
							...
							<div class="inbox-menu">
								<ul>
									...
									<li>
										...
										>
											<i aria-hidden="true" class="iconify" data-icon="feather:alert-octagon"></i>
											<span>Spam</span>
						...
						<div class="scroll-menu">
							<div class="title-wrap">
								...
								<div :class="[!contactSearchOpen && 'is-hidden']" class="control has-icon">
					...
					<div class="header-area">
						...
						<div class="actions">
							<div class="control inbox-search has-icon">
								<input type="text" class="input is-rounded" placeholder="Search Inbox..." />
								<div class="form-icon">
									<i aria-hidden="true" class="iconify" data-icon="feather:search"></i>
								</div>
							</div>

							<div ref="dropdownElement2" class="dropdown inbox-dropdown dropdown-trigger is-right">
								<div>
								...
								<div class="dropdown-menu">
									<div class="dropdown-content">
										...
										<a class="dropdown-item">
											<i aria-hidden="true" class="iconify" data-icon="feather:eye-off"></i>
											<span>Hide read</span>
										</a>
