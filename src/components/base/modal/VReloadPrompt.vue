...
<i18n lang="yaml">
de:
  offline-ready: '{appName} Está disposto a trabalhar offline'
  need-refresh: 'Uma nova versão do {appName} está disponível, clique no botão Reload para atualizá-lo.'
